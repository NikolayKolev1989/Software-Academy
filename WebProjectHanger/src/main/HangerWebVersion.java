...
public class HangerWebVersion {
	...
	public static void generateWord() {
		...
		wordToGuess = wordList[wordPos]; // Генениране на произволна дума от Листа с думи
	}

	public static void main(String[] args) {

		String censoredWord = "";
		for (int i = 0; i < wordToGuess.length(); i++) { // Генериране на Стринг от '*' с брой равен на броя на буквите
															// в избраната дума
			censoredWord += "*";
		}

		// String result [] = censoredWord.split(" "); // Създаваме масив от стрингове,
		// които са символите на цензурираната дума с премахнат интервал
		int mistakes = 0;
...
// Ако въведеното от потребителя е дума
			if (entryCharCount > 1) {
				...
				/*
				 * Ако въведеното от потребителя е символ Проверка дали символа въведен от
				 * потребителя съществува в думата
				 */
			} else {
