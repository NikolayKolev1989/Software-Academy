...
<body bgcolor="white">
	...
	<!-- ------CHOOSE SECTION FORM------ -->
	<form method="post" action="case5.jsp">
		<header>
			<h2>
				<a href="index.jsp">&#x2190; Cases</a>
			</h2>
			<h2 align="center">Case 5</h2>
			<div class="nav">
				<ul class="nav-main">
								...
								<tbody>
									<tr>
										...
										<td><input type="text" name="reaction"
											disabled="disabled" value="A=B=P/2"> N</td>
									</tr>
									<tr>
							...
							<table border="1">
								<tbody>
									...
									<tr>
										...
										<td><input type="text" name="lenghtx" class="selector"
											disabled> m</td>
									</tr>
								</tbody>
							</table>
						</td>
						<td><img src="cases-images/case5.png" alt="image not found">
						</td>
