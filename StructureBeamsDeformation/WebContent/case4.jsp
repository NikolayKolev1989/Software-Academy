...
<body bgcolor="white">
	...
	<!-- ------CHOOSE SECTION FORM------ -->
	<form method="post" action="case4.jsp">
		<header>
			<h2>
				<a href="index.jsp">&#x2190; Cases</a>
			</h2>
			<h2 align="center">Case 4</h2>
			<div class="nav">
				<ul class="nav-main">
								...
								<tbody>
									<tr>
										...
										<td><input type="text" name="reaction"
											disabled="disabled" value="A=P.b/2"> N</td>
									</tr>
									<tr>
										<td><label for="reactionB">Reaction force [B]:</label></td>
										<td><input type="text" name="reaction" value="B=P.a/2"
											disabled="disabled"> N</td>
									</tr>
									<tr>
							...
							<table border="1">
								<tbody>
									<tr>
										...
										<td><input type="text" name="reaction" class="selector"
											disabled> N</td>
									</tr>
									<tr>
										<td><label for="lenght">Total lenght [L]:</label></td>
										<td><input type="text" name="lenght" class="selector"
											disabled> m</td>
									</tr>
									<tr>
										<td><label for="lenghta">Lenght [a]:</label></td>
										<td><input type="text" name="lenghta" class="selector"
											disabled> m</td>
									</tr>
									<tr>
										<td><label for="lenghtb">Lenght [b]:</label></td>
										<td><input type="text" name="lenghtb" class="selector"
											disabled> m</td>
									</tr>
								</tbody>
							</table>
						</td>
						<td><img src="cases-images/case4.png" alt="image not found">
						</td>
							...
							<table border="1">
								<tbody>
									<tr>
										...
										<td><input type="text" name="deformamtionP"
											name="deformationP" disabled>
									</tr>
									<tr>
										<td><label for="deformationX">Deformation at X:</label></td>
										<td><input type="text" name="deformamtionX"
											name="deformationX" disabled>
									</tr>
								</tbody>
							</table>
						</td>
